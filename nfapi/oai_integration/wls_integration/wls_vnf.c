...
int wls_vnf_nr_pack_and_send_p5_message(void *vnf_ptr,uint16_t p5_idx, nfapi_nr_p4_p5_message_header_t *msg, uint32_t msg_len)
{
...
int wls_vnf_nr_pack_and_send_p7_message(void* vnf_p7_ptr,nfapi_nr_p7_message_header_t *msg)
{
  UNUSED_VARIABLE(vnf_p7_ptr);
