...
| Supermicro Grace Hopper MGX ARS-111GL-NHR (Neoverse-V2, 3.4GHz, 72C/72T, 576GB LPDDR5) | Ubuntu 22.04.5 LTS (6.5.0 lowlatency) |NVIDIA BlueField3 (32.41.1000)|
...
The currently used Aerial Version is 24-3, which is also the one currently used by the SDK Manager.
